  ...
  pull(pullCount?: integer, count?: integer, eggs?: Egg[]): void {
    ...
    if (!eggs) {
      ...
      for (let i = 1; i <= pullCount; i++) {
        ...
        eggOptions.tier = this.scene.mods.overrideEggRarity(eggOptions.sourceType);
      ...
      if (this.eggGachaSummaryContainer.visible) {
        ...
        case Button.ACTION:
          ...
          case 0:
            ...
            break;
          case 2:
            if (!this.scene.mods.infiniteVouchers && !this.scene.gameData.voucherCounts[VoucherType.PLUS] && !Overrides.EGG_FREE_GACHA_PULLS_OVERRIDE) {
              error = true;
              this.showError(i18next.t("egg:notEnoughVouchers"));
          ...
          case 3:
            ...
            break;
          case 4:
            if (!this.scene.mods.infiniteVouchers && !this.scene.gameData.voucherCounts[VoucherType.GOLDEN] && !Overrides.EGG_FREE_GACHA_PULLS_OVERRIDE) {
              error = true;
              this.showError(i18next.t("egg:notEnoughVouchers"));
