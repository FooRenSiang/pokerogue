...
export class NavigationManager {
  ...
  constructor() {
    ...
    this.labels = [i18next.t("settings:general"), i18next.t("settings:display"), i18next.t("settings:audio"), i18next.t("settings:gamepad"), i18next.t("settings:keyboard"), "Mods"];
  }
